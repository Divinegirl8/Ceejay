        ...
        <>
            <div className="md:border-t md:border-b border-[#5A5A5A] flex flex-col xl:flex-row">
                ...
                <div className="xl:px-16 md:px-10 md:py-16 px-7  border-b border-[#5A5A5A] relative">
                        ...
                        <button className="absolute -bottom-[26px] max-lg:right-16  px-8 py-3 border border-[#5A5A5A] bg-white rounded-full text-base hover:bg-gray-50 transition-colors inline-flex items-center gap-2 cursor-pointer"  onClick={() => window.open('https://www.cliqmit.com/', '_blank')}>
                            Visit Website 
