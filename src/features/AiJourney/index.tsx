        ...
        {journeyItems.map((item) => (
          <div key={item.id}>
            ...
            <div
              ...
              className={`flex lg:flex-row flex-col lg:justify-between lg:items-center md:mt-5 lg:mt-0 px-7 max-md:py-5 lg:px-10 xl:px-20 relative transition-colors duration-300 z-10 min-h-[170px] ${
